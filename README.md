...
Этот репозиторий содержит исходный код простого TCP-клиента, который был специально разработан для курсовой работы.
...
Также необходимо создать файлы для хранения передаваемых значений и результатов, полученных от сервера (_input.txt_, _output.bin_).
...
8193 -409 3453
```
Вы также можете изменить содержимое файла _client.config_, в котором хранится информация о пользователях для авторизации.
